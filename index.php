	...
	<body class="is-preload">
		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/amsterdam.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
							<h2>저는 이런 사람입니다.</h2>
						</header>
			...
			<section id="two" class="main special">
				<div class="container">
					...
					<div class="content">
						...
						<p>감각적인 풀스택 개발을 희망하는 주니어 개발자.</br></p>
						<ul class="icons-grid">
							<li>
							...
							<li>
								...
								<h3>Android - Kotlin</br>(Coroutine 학습 중)</h3>
							</li>
							<li>
								<span class="icon solid major fa-database"></span>
								<h3>App Server - Spring Boot</h3>
							</li>
							<li>
								<span class="icon solid major fa-code"></span>
								<h3>Web FrontEnd</br>(간단한 게시판 작성)</h3>
							</li>
						</ul>
					</div>
			...
			<section id="three" class="main special">
				<div class="container">
					...
					<div class="content">
						...
						<ul class="icons-grid">	
						<li>
								<span class="icon brands major fa-github-square"></span>
								<h3>개발 협업 - Github</h3>
							</li>
							<li>
								<span class="icon solid major fa-pencil-alt"></span>
								<h3>디자인 협업 - Adobe Xd</h3>
							</li>
							<li>
